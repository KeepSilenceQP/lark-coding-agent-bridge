  ...
  return [
    {
      ...
      aliases: [],
      appId: 'cli_history_redacted_1',
      role: 'bridge',
      machines: [{ kind: 'local', root: '/redacted/history/machine-1' }],
      projectRoot: 'lark-coding-agent-bridge',
    },
    {
      canonicalName: 'HistoryRedactedBot2',
      aliases: [],
      appId: 'cli_history_redacted_2',
      role: 'bridge',
      machines: [{ kind: 'devbox', root: '/redacted/history/machine-2' }],
      projectRoot: 'lark-coding-agent-bridge',
    },
    {
      canonicalName: '云上HistoryRedactedBot1',
      aliases: [],
      appId: 'cli_history_redacted_3',
      role: 'bridge',
      machines: [{ kind: 'devbox', root: '/redacted/history/machine-2' }],
      projectRoot: 'lark-coding-agent-bridge',
    },
